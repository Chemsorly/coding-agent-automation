...
public static class LucideIcons
{
    public static readonly FrozenDictionary<string, string> Icons = new Dictionary<string, string>
    {
        ...
        // TODO: brain, search, and sparkles SVG paths were replaced with different Lucide variants — verify visual consistency with pre-existing usages (AgentMonitoring, PipelineSidebar, AgentCoding)
        ...
        ["layers"] = """<path d="m12.83 2.18a2 2 0 0 0-1.66 0L2.6 6.08a1 1 0 0 0 0 1.83l8.58 3.91a2 2 0 0 0 1.66 0l8.58-3.9A1 1 0 0 0 21.4 6z"/><path d="m6.08 9.5-3.52 1.6a1 1 0 0 0 0 1.83l8.58 3.9a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.82L18 9.5"/><path d="m6.08 14.5-3.52 1.6a1 1 0 0 0 0 1.83l8.58 3.9a2 2 0 0 0 1.66 0l8.58-3.9a1 1 0 0 0 0-1.82L18 14.5"/>""",
    }.ToFrozenDictionary();
}
