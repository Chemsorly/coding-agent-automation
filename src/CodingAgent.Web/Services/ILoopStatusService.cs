...
/// Mirrors the read-only surface of <see cref="CodingAgent.Pipeline.Interfaces.IPipelineLoopService"/>
/// so <see cref="CodingAgent.Web.Components.Pages.Overview"/> and
/// <see cref="CodingAgent.Web.Components.Pages.AgentCoding"/> can bind without changes.
/// <para>
