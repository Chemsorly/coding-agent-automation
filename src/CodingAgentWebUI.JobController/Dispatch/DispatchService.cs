...
public sealed class DispatchService : LeaderElectedPollingService
{
    ...
    {
        Log.Debug("DispatchService config: ChatAgentJobTimeoutSeconds={ChatTimeout}s, ChatPodConnectTimeoutSeconds={ConnectTimeout}s, " +
                  "ChatTerminationGracePeriodSeconds={TerminationGrace}s, PollIntervalSeconds={PollInterval}s, " +
                  "KiroPvcPool=[{PvcPool}]",
            _options.ChatAgentJobTimeoutSeconds,
