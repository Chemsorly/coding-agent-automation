...
public interface IOrchestratorRunService
{
    ...
    /// </summary>
    void MarkRecentlyCompleted(string issueIdentifier, ProviderConfigId issueProviderConfigId);
    ...
    /// </summary>
    bool WasRecentlyCompleted(string issueIdentifier, ProviderConfigId issueProviderConfigId);
}
