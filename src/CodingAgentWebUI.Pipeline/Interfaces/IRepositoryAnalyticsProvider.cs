...
/// <summary>
/// Repository analytics and staleness detection.
/// Consumed by <c>DispatchInfrastructure</c> (via <c>AnalysisStalenessDetector</c>) to
/// determine whether the codebase has evolved significantly since the last analysis.
/// </summary>
