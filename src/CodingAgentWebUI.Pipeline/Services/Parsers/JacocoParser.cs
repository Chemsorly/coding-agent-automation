...
/// <summary>
/// Parses JaCoCo XML coverage reports to extract line coverage percentage.
/// </summary>
public static class JacocoParser
{
    /// <summary>
    ...
    /// </summary>
    public static double ParseCoverage(string[] jacocoFiles)
    {
        var totalMissed = 0L;
        var totalCovered = 0L;
