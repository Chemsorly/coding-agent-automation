...
public static partial class PromptBuilder
{
    ...
    public static string BuildCleanupPrompt()
    {
        ...
        sb.AppendLine();
        sb.AppendLine("Quality gates have passed. Perform one cleanup pass over files changed in this branch, then stop. Do not touch files outside the diff.");
        sb.AppendLine();
        sb.AppendLine("**Budget: 10 tool calls maximum.** Use them efficiently — you are not expected to do deep analysis.");
        sb.AppendLine();
        ...
        sb.AppendLine("- Continue after writing the report");
        sb.AppendLine();
