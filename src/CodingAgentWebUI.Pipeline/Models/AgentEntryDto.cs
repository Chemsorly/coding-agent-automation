...
/// fields populated from the active <see cref="PipelineRun"/> (when available). This allows
...
public sealed record AgentEntryDto
{
    ...
    /// <see cref="PipelineRun.IssueIdentifier"/>.
    /// </summary>
    ...
    /// <summary>
    /// Projects an <see cref="AgentEntry"/> into an <see cref="AgentEntryDto"/>, enriching with
    /// data from the supplied <paramref name="run"/> when available.
    /// </summary>
