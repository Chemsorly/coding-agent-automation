...
#pragma warning restore CS0618
    ...
    /// <summary>AI-generated summary of what the PR changed (from review summary agent).</summary>
    public string? CodeReviewChangeSummary { get; set; }

    /// <summary>AI-generated synthesized review verdict (from review summary agent).</summary>
