...
/// <see cref="CodingAgent.Pipeline.Services.Steps.PipelineStepContext"/> instead:
/// <list type="bullet">
///   <item><see cref="CodingAgent.Pipeline.Services.Steps.ReviewCodeStep"/> — uses
...
///   <item><see cref="CodingAgent.Pipeline.Services.Steps.RunQualityGatesStep"/> — uses
///     <c>PreResolvedQualityGateConfigs</c> from the job assignment.</item>
///   <item><see cref="CodingAgent.Pipeline.Services.Steps.VerifyBaselineStep"/> — uses
///     <c>PreResolvedQualityGateConfigs</c> from the job assignment; returns a safe skip when the
///     store returns an empty list.</item>
///   <item><see cref="CodingAgent.Pipeline.Services.Steps.RunEnvironmentSetupStep"/> — calls
...
/// <see cref="CodingAgent.Agent.PipelineExecutionContextBuilder"/>.
/// </para>
/// </summary>
