...
#pragma warning restore S3236
    ...
    /// cycle's eligibility set. Decomposition and Consolidation items are skipped (fail-open).
    /// Default: true (on by default — disable explicitly if the sweep causes problems).
    /// </summary>
    [Key(79)]
