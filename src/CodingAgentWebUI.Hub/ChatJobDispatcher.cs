...
public sealed partial class ChatJobDispatcher : IHostedService, IAsyncDisposable, IChatJobDispatcher
{
        ...
        CancellationToken cancellationToken)
    {
        var ctx = new JobSpecBuilder.BuildContext
        {
            ...
            TimeoutSeconds = _options.ChatAgentJobTimeoutSeconds,
            JobName = jobName,
            ClaimedPvc = claimedPvc,
        ...
        job.Spec.ActiveDeadlineSeconds = _options.ChatAgentJobTimeoutSeconds;
        ...
        string jobName, WatcherEntry entry, CancellationToken ct)
    {
        ...
        finally
        {
            ...
            // call in the catch body) throws — preventing session counter and _activeWatchers
            // entry leaks.
