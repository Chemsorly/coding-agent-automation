...
public sealed class GitHubAppAuthService
{
    ...
    ///
    /// Access is granted to the test project via <c>&lt;InternalsVisibleTo Include="CodingAgent.Infrastructure.UnitTests" /&gt;</c>
    ...
    {
        return CodingAgent.Pipeline.GitHub.GitHubJwtGenerator.GenerateFromPem(_clientId, _privateKeyPem);
    }
}
