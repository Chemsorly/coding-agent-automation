...
public class JsonConfigurationStore : IConfigurationStore
{
    ...
    private readonly IReadOnlyList<ProviderConfig>?[] _providerConfigsCache = new IReadOnlyList<ProviderConfig>?[5]; // indexed by (int)ProviderKind — update size if enum grows
