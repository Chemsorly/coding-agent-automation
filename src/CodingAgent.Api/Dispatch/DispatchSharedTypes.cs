...
/// Previously defined in <c>CodingAgent.Orchestration.Dispatch</c> (Spec 043 dead code);
...
/// Previously defined in <c>CodingAgent.Orchestration.Dispatch</c>; moved here (arch-audit 2026-08-22).
/// </summary>
