...
namespace CodingAgent.Web.UnitTests.ApiClient;

/// <summary>
/// Tests for <see cref="PipelineApiWorkItemClient.SetPriorityAsync"/> using a
/// fake <see cref="HttpMessageHandler"/>. These tests live in CodingAgent.Web.UnitTests
/// (not Infrastructure.UnitTests) so that coverlet captures coverage for the
/// CodingAgent.Api.Client assembly, which is included in this project's
