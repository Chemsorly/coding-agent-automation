...
internal static class E2ETestDefaults
{
    ...
    public static void ApplyDispatchEnvironment()
    {
        ...
        Environment.SetEnvironmentVariable("WorkDistribution__Dispatch__ChatAgentJobTimeoutSeconds", "7200");
        ...
        Environment.SetEnvironmentVariable("WorkDistribution__Dispatch__ChatIdleTimeoutSeconds", "90");
    }
        ...
        foreach (var key in new[]
                 {
                     ...
                     "WorkDistribution__Dispatch__ChatAgentJobTimeoutSeconds",
