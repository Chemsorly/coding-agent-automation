...
public partial class SonarGateBugConditionTests
{
    ...
    public void AllListedTestMethods_MustContainAtLeastOneAssertion()
    {
        ...
        var testLocations = new (string RelativePath, int LineNumber, string Description)[]
        {
            ...
            // Additional 14
            ("tests/CodingAgent.Pipeline.UnitTests/Services/AgentHubFacadeProgressTrackingTests.cs",        122, "AgentHubFacadeProgressTrackingTests line 122"),
            ...
            ("tests/CodingAgent.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 136, "WorkItemStateMachinePropertyTests line 136"),
            ("tests/CodingAgent.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 154, "WorkItemStateMachinePropertyTests line 154"),
            ("tests/CodingAgent.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 169, "WorkItemStateMachinePropertyTests line 169"),
            ...
            ("tests/CodingAgent.Web.UnitTests/DispatchOrchestrationServiceTests.cs",                          1622,  "DispatchOrchestrationServiceTests line 1622 (RevertFailedDistribution_SwapsLabelBackToNext)"),
