...
public partial class SonarGateBugConditionTests
{
    ...
    public void AllListedTestMethods_MustContainAtLeastOneAssertion()
    {
        ...
        var testLocations = new (string RelativePath, int LineNumber, string Description)[]
        {
            ...
            ("tests/CodingAgent.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 141, "WorkItemStateMachinePropertyTests line 141"),
            ("tests/CodingAgent.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 159, "WorkItemStateMachinePropertyTests line 159"),
            ("tests/CodingAgent.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 178, "WorkItemStateMachinePropertyTests line 178"),
            ...
            ("tests/CodingAgent.Web.UnitTests/DispatchOrchestrationServiceTests.cs",                          2079,  "DispatchOrchestrationServiceTests line 2079 (RevertFailedDistribution_SwapsLabelBackToNext)"),
