...
public class WriteOpenIssueContextStepTests
{
    ...
    public async Task ExecuteAsync_DecompositionAnalysisRun_IncludesClosedSiblings()
    {
        _writer
            .Setup(w => w.WriteOpenIssueContextAsync(
                It.IsAny<IAgentIssueOperations>(), It.IsAny<WorkspacePath>(), It.IsAny<int>(), true, It.IsAny<CancellationToken>()))
            .ReturnsAsync(3);
    ...
    public async Task ExecuteAsync_PassesMaxIssuesFromConfig()
    {
        _writer
            .Setup(w => w.WriteOpenIssueContextAsync(
                It.IsAny<IAgentIssueOperations>(), It.IsAny<WorkspacePath>(), 25, It.IsAny<bool>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(0);
    ...
    public async Task ExecuteAsync_ReviewRun_ExcludesClosedSiblings()
    {
        _writer
            .Setup(w => w.WriteOpenIssueContextAsync(
                It.IsAny<IAgentIssueOperations>(), It.IsAny<WorkspacePath>(), It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<CancellationToken>()))
            .ReturnsAsync(0);
