...
public class DispatchServiceConsolidationTests : IDisposable
{
    ...
    public async Task FullLifecycle_ConsolidationInsert_Dispatch_Complete()
    {
        ...
        // Pending enqueue path: Queued=true (item is Pending in the visible UI queue)
        ...
        {
            seedDb.WorkItems.Add(new CodingAgent.Infrastructure.Persistence.Entities.WorkItemEntity
            {
                Id = workItemId,
    ...
    {
        // Exercises the public ConsolidationWorkItemDispatchService(ConsolidationWorkItemDispatchServiceDependencies deps)
        // constructor in the CodingAgent.Pipeline.UnitTests coverage domain.
        ...
        var handler = new ConsolidationWorkItemDispatchService(
