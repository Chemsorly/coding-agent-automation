...
using ApiBackedPipelineRunHistoryService = CodingAgent.Api.Client.Stores.ApiBackedPipelineRunHistoryService;
using Moq;
...
public sealed class ApiBackedServicesTests
{
    ...
    {
        var mockClient = new Mock<CodingAgent.Api.Client.IPipelineApiWorkItemClient>();
    ...
    private static ApiBackedPipelineRunHistoryService CreateHistoryService(
        CodingAgent.Api.Client.IPipelineApiRunHistoryClient client)
    ...
    {
        var client = new Mock<CodingAgent.Api.Client.IPipelineApiChatClient>();
