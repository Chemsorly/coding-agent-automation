...
public class GitHubProviderResilienceTests
{
    ...
    /// </summary>
    private sealed class TestableResilienceProvider : CodingAgent.Infrastructure.GitHub.GitHubProviderBase
    {
        public TestableResilienceProvider(IGitHubClient client)
            : base(new CodingAgent.Infrastructure.GitHub.GitHubConnectionInfo("https://api.github.com", "test-owner", "test-repo"), client)
        {
        }
