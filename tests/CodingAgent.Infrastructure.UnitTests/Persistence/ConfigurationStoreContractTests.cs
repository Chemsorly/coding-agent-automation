...
/// <summary>
/// Runs the contract tests against <see cref="CodingAgent.Api.Client.Stores.ApiConfigurationStore"/>.
///
...
public sealed class ApiConfigurationStoreContractTests : ConfigurationStoreContractTests
{
    ...
    private static CodingAgent.Api.Client.Stores.ApiConfigurationStore BuildStore(Mock<IPipelineApiConfigClient> client)
    {
        ...
        var pipeline = new CodingAgent.Api.Client.Stores.ApiPipelineConfigStore(client.Object) { CacheTtlSeconds = 0 };
        var providers = new CodingAgent.Api.Client.Stores.ApiProviderConfigStore(client.Object) { CacheTtlSeconds = 0 };
        var projects = new CodingAgent.Api.Client.Stores.ApiProjectStore(client.Object) { CacheTtlSeconds = 0 };
        return new CodingAgent.Api.Client.Stores.ApiConfigurationStore(client.Object, pipeline, providers, projects)
            { CacheTtlSeconds = 0 };
    }
}
...
{
    private static CodingAgent.Web.TestUtilities.InMemoryConfigurationStore CreateStore()
        => new();
...
/// <see cref="CodingAgent.Web.TestUtilities.InMemoryConfigurationStore"/>.
///
...
{
    protected override IConfigurationStore CreateStore()
        => new CodingAgent.Web.TestUtilities.InMemoryConfigurationStore();
