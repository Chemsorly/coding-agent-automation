...
/// <summary>
/// Runs the contract tests against <see cref="CodingAgent.Web.Services.ApiBackedConsolidationRunStore"/>.
...
public sealed class ApiBackedConsolidationRunStoreContractTests : ConsolidationRunStoreContractTests
{
    ...
    protected override IConsolidationRunStore CreateStore()
    {
        ...
        _store.Clear();
        return new CodingAgent.Web.Services.ApiBackedConsolidationRunStore(_client.Object);
    }
}
