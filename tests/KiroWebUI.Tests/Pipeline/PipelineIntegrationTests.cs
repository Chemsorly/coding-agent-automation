...
public class PipelineIntegrationTests : IntegrationTestBase
{
    ...
    public async Task FullPipelineFlow_RealInternalServices()
    {
        ...
        // the agent should have received a prompt containing the parsed requirements
        MockAgentProvider.Verify(p => p.ExecuteAsync(
            It.Is<AgentRequest>(r => r.Prompt.Contains("null checks") && r.Prompt.Contains("public methods")),
