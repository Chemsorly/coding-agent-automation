...
/// one <see cref="CodingAgent.Web.TestUtilities.FakeRedisStore"/>, exercising the distributed
/// service layer (<see cref="DistributedAgentRegistryService"/>,
/// <see cref="CodingAgent.Orchestration.DistributedRunService"/>,
/// <see cref="CodingAgent.Orchestration.Dispatch.AgentReservationService"/>) across replica
/// boundaries without Docker.
///
/// <para>
/// <b>Known gap:</b> Lua script atomicity is not simulated. <c>RemoveRun</c> uses a single Lua
/// SREM + EXPIREAT on real Redis; in <see cref="CodingAgent.Web.TestUtilities.FakeRedisStore"/>
