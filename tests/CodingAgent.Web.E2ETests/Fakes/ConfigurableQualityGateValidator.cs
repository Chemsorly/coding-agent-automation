...
public sealed class ConfigurableQualityGateValidator : IQualityGateValidator
{
    ...
    public Task<QualityGateReport> ValidateAsync(WorkspacePath workspacePath, IReadOnlyList<QualityGateConfiguration> qualityGateConfigs, CancellationToken ct, string? baseBranch = null)
    {
