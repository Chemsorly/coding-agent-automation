...
public sealed class ActiveRunRehydrationIntegrationTests : IDisposable
{
    ...
    // If WhereActive() is extended (e.g. a new active status is added), this helper will silently diverge and
    // the integration test will stop covering real behaviour. Replace with .WhereActive() when refactoring
