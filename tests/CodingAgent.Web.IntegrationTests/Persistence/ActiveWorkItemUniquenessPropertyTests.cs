...
namespace CodingAgent.Web.IntegrationTests.Persistence;
...
public class ActiveWorkItemUniquenessPropertyTests : IDisposable
{
    ...
    public ActiveWorkItemUniquenessPropertyTests()
    {
        ...
        // API client: routes by TaskType.
        // Implementation/Review → CreateAsync (Pending enqueue path).
        // Consolidation → DispatchAsync (synchronous path).
