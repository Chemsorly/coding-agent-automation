    ...
    private DispatchOrchestrationService CreateOrchestrationService()
    {
        ...
        return new DispatchOrchestrationService(
            new DispatchInfrastructure(
                ...
                new DispatchResolutionService(new ProfileResolver(), new QualityGateResolver(), new ReviewerResolver(), _mockConfigStore.Object, _mockConfigStore.Object, _mockConfigStore.Object, _mockConfigStore.Object, _mockConfigStore.Object, _mockConfigStore.Object, _mockLogger.Object)),
            orchestration,
            _runService,
