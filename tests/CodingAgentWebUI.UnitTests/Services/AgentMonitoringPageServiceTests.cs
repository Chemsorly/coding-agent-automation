...
public sealed class AgentMonitoringPageServiceTests
{
    ...
    public AgentMonitoringPageServiceTests()
    {
        ...
        _mockRunHistoryClient.Setup(h => h.GetRunHistoryAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<PipelineStep?>(), It.IsAny<CancellationToken>()))
    ...
    public async Task InitializeAsync_LoadsDataAndRefreshes()
    {
        ...
        _mockRunHistoryClient.Verify(s => s.GetRunHistoryAsync(It.IsAny<int>(), It.IsAny<int>(), It.IsAny<bool>(), It.IsAny<bool>(), It.IsAny<PipelineStep?>(), It.IsAny<CancellationToken>()), Times.Once);
