...
public class PipelineRunHighWaterMarkTests
{
    ...
    public PipelineRunHighWaterMarkTests()
    {
        ...
        _service = new TestPipelineRunner(
            ...
            new QualityGateExecutor(_mockValidator.Object, new PullRequestOrchestrator(mockLogger.Object), new CiLogWriter(mockLogger.Object), new FeedbackService(mockLogger.Object), mockLogger.Object),
            mockLogger.Object,
