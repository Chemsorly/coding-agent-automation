    ...
    public static Arbitrary<JobDistributionRequest> JobDistributionRequestArb()
    {
        var gen =
            ...
            select new JobDistributionRequest
            {
                ...
                BrainProviderConfigId = hasBrain ? new ProviderConfigId(brainConfigId) : (ProviderConfigId?)null,
                PipelineProviderConfigId = hasPipeline ? new ProviderConfigId(pipelineConfigId) : (ProviderConfigId?)null,
