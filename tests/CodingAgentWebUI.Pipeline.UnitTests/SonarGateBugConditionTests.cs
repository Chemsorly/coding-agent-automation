...
public partial class SonarGateBugConditionTests
{
    ...
    public void AllListedTestMethods_MustContainAtLeastOneAssertion()
    {
        ...
        var testLocations = new (string RelativePath, int LineNumber, string Description)[]
        {
            ...
            ("tests/CodingAgentWebUI.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 143, "WorkItemStateMachinePropertyTests line 143 (EveryNonTerminalState_CanReachATerminalState)"),
            ("tests/CodingAgentWebUI.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 163, "WorkItemStateMachinePropertyTests line 163 (TerminalStates_HaveNoOutgoingTransitions)"),
            ("tests/CodingAgentWebUI.Infrastructure.UnitTests/Persistence/WorkItemStateMachinePropertyTests.cs", 179, "WorkItemStateMachinePropertyTests line 179 (Pending_OnlyReachableFrom_Dispatched)"),
            ...
            ("tests/CodingAgentWebUI.UnitTests/DispatchOrchestrationServiceTests.cs",                          1371,  "DispatchOrchestrationServiceTests line 1371 (RevertFailedDistribution_SwapsLabelBackToNext)"),
