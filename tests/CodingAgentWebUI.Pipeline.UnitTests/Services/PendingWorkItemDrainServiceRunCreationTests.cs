...
public class PendingWorkItemDrainServiceRunCreationTests : IDisposable
{
    ...
    private PendingWorkItemDrainService CreateService()
    {
        return new PendingWorkItemDrainService(
            ...
            new DispatchRevertService(_dbFactory, _mockAgentResolver.Object, _mockRunService.Object, _transitionService, NullLogger<DispatchRevertService>.Instance),
            // TODO: The DispatchRevertService inside DispatchAttemptService is a separate instance from the one
            // passed as the third constructor argument. Both use the same backing _dbFactory so they are
            // functionally equivalent for stateless DB operations, but if DispatchRevertService ever gains
            ...
            // test fixtures.
            new DispatchAttemptService(_transitionService, new DispatchRevertService(_dbFactory, _mockAgentResolver.Object, _mockRunService.Object, _transitionService, NullLogger<DispatchRevertService>.Instance)));
    }
