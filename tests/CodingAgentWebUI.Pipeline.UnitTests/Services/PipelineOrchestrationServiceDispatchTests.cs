...
public class PipelineOrchestrationServiceDispatchTests : IDisposable
{
    ...
    public PipelineOrchestrationServiceDispatchTests()
    {
        ...
        _service = new PipelineOrchestrationService(
            ...
            new QualityGateExecutor(mockValidator.Object, new PullRequestOrchestrator(_mockLogger.Object), _mockLogger.Object),
            _mockLogger.Object,
    ...
    public async Task RemoveAllAgentLabelsAsync_RemovesAllLabels()
    {
        ...
        var service = new PipelineOrchestrationService(
            ...
            new IssueDescriptionParser(),
            new AgentPhaseExecutor(_mockLogger.Object),
            new QualityGateExecutor(mockQgValidator.Object, new PullRequestOrchestrator(_mockLogger.Object), _mockLogger.Object),
            _mockLogger.Object,
            brainUpdateService: new Mock<IBrainUpdateService>().Object,
            historyService: mockHistoryService.Object,
            runService: _mockRunService.Object);
