...
public class BrainSyncUnitTests
{
    ...
    // moved to CodingAgentWebUI.Infrastructure.UnitTests (concrete BrainUpdateService behavior)
    ...
    private class TestRepositoryProvider : IRepositoryProvider
    {
        ...
        public Task<string> CreateBranchAsync(WorkspacePath workspacePath, string branchName, CancellationToken ct) => Task.FromResult(branchName);
