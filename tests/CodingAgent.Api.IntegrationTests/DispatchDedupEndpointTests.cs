...
/// (tests/CodingAgent.Infrastructure.UnitTests/Persistence), which asserts the same
/// invariant against the DB-backed copy in DbWorkDistributorBase.
///
/// Driven over HTTP: the handlers are internal to CodingAgent.Api, which grants no
