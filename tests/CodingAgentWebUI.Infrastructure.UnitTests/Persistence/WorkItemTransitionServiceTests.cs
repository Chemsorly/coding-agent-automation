...
{
    [Theory]
    [InlineData(WorkItemStatus.Pending, WorkItemStatus.Dispatched, true)]   // Consolidation path still uses Pending→Dispatched
    ...
    [InlineData(WorkItemStatus.Dispatched, WorkItemStatus.Pending, true)]   // Retained for consolidation requeue recovery
