...
public class IPipelineExecutorTests
{
    ...
    public void DI_CanResolve_IPipelineExecutor()
    {
        ...
        services.AddSingleton<CodingAgent.Pipeline.Interfaces.IQualityGateValidator>(
            Mock.Of<CodingAgent.Pipeline.Interfaces.IQualityGateValidator>());
        services.AddSingleton<IPipelineExecutor>(sp => new LocalPipelineExecutor(new LocalPipelineExecutorDependencies(
            ...
            sp.GetRequiredService<CodingAgent.Pipeline.Interfaces.IQualityGateValidator>(),
            Serilog.Log.Logger,
