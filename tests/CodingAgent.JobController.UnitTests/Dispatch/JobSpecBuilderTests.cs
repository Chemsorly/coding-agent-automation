...
public sealed class JobSpecBuilderTests
{
    ...
    public void WhenDerivedKeySecretName_Set_AgentApiKeyEnvVar_FromSecret_NoMasterMount()
    {
        ...
        // WorkItemId is now non-null alongside DerivedKeySecretName — the guard added in #2234 was
        // removed in issue #3034. Work-item pods MUST use DerivedKeySecretName to receive the
        // pre-vended per-job key without holding the master key.
